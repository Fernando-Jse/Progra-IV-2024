Vue.component('componente-autors', {
    ...
    methods:{
        ...
        guardarAutor(){
            //almacenamiento del objeto Autors en indexedDB
            let store = abrirStore('autors', 'readwrite'),
            ...
            query.onerror = e=>{
                console.error('Error al guardar en autors', e.message());
            };
        },
        nuevoAutor(){
            this.accion = 'nuevo';
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr @click="modificarAutor(autor)" v-for="autor in autors" :key="autor.idAutor">
                                        ...
                                        <td><button @click.prevent.default="eliminarAutor(autor.idAutor)" class="btn btn-outline-danger">delete</button></td>
                                    </tr>
                                </tbody>
                            </table>
                        </form>
